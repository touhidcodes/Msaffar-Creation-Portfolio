...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      RecentWork: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.RecentWorkFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.RecentWorkAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type RecentWorkOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "description" | "images" | "tags" | "isFeatured" | "isDeleted" | "binanceProfileUrl" | "tools" | "client" | "projectDuration" | "createdAt" | "updatedAt", ExtArgs["result"]["recentWork"]>
  ...
  export interface RecentWorkDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more RecentWorks that matches the filter.
     * @param {RecentWorkFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const recentWork = await prisma.recentWork.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: RecentWorkFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a RecentWork.
     * @param {RecentWorkAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const recentWork = await prisma.recentWork.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: RecentWorkAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface RecentWorkFieldRefs {
    ...
    readonly name: FieldRef<"RecentWork", 'String'>
    readonly description: FieldRef<"RecentWork", 'String'>
    readonly images: FieldRef<"RecentWork", 'String[]'>
    readonly tags: FieldRef<"RecentWork", 'String[]'>
    readonly isFeatured: FieldRef<"RecentWork", 'Boolean'>
    readonly isDeleted: FieldRef<"RecentWork", 'Boolean'>
    readonly binanceProfileUrl: FieldRef<"RecentWork", 'String'>
    readonly tools: FieldRef<"RecentWork", 'String[]'>
    readonly client: FieldRef<"RecentWork", 'String'>
    readonly projectDuration: FieldRef<"RecentWork", 'String'>
   ...
   * RecentWork findRaw
   */
  export type RecentWorkFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * RecentWork aggregateRaw
   */
  export type RecentWorkAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type RecentWorkWhereInput = {
    ...
    name?: StringFilter<"RecentWork"> | string
    description?: StringFilter<"RecentWork"> | string
    images?: StringNullableListFilter<"RecentWork">
    tags?: StringNullableListFilter<"RecentWork">
    isFeatured?: BoolFilter<"RecentWork"> | boolean
    isDeleted?: BoolFilter<"RecentWork"> | boolean
    binanceProfileUrl?: StringNullableFilter<"RecentWork"> | string | null
    tools?: StringNullableListFilter<"RecentWork">
    client?: StringNullableFilter<"RecentWork"> | string | null
    projectDuration?: StringNullableFilter<"RecentWork"> | string | null
  ...
  export type RecentWorkScalarWhereWithAggregatesInput = {
    ...
    name?: StringWithAggregatesFilter<"RecentWork"> | string
    description?: StringWithAggregatesFilter<"RecentWork"> | string
    images?: StringNullableListFilter<"RecentWork">
    tags?: StringNullableListFilter<"RecentWork">
    isFeatured?: BoolWithAggregatesFilter<"RecentWork"> | boolean
    isDeleted?: BoolWithAggregatesFilter<"RecentWork"> | boolean
    binanceProfileUrl?: StringNullableWithAggregatesFilter<"RecentWork"> | string | null
    tools?: StringNullableListFilter<"RecentWork">
    client?: StringNullableWithAggregatesFilter<"RecentWork"> | string | null
    projectDuration?: StringNullableWithAggregatesFilter<"RecentWork"> | string | null
  ...
  export type RecentWorkCreateInput = {
    ...
    name: string
    description: string
    images?: RecentWorkCreateimagesInput | string[]
    tags?: RecentWorkCreatetagsInput | string[]
    isFeatured?: boolean
    isDeleted?: boolean
    binanceProfileUrl?: string | null
    tools?: RecentWorkCreatetoolsInput | string[]
    client?: string | null
    projectDuration?: string | null
    createdAt?: Date | string
    updatedAt?: Date | string
  ...
  export type RecentWorkUpdateInput = {
    ...
    images?: RecentWorkUpdateimagesInput | string[]
    tags?: RecentWorkUpdatetagsInput | string[]
    isFeatured?: BoolFieldUpdateOperationsInput | boolean
    isDeleted?: BoolFieldUpdateOperationsInput | boolean
    binanceProfileUrl?: NullableStringFieldUpdateOperationsInput | string | null
    tools?: RecentWorkUpdatetoolsInput | string[]
    client?: NullableStringFieldUpdateOperationsInput | string | null
    projectDuration?: NullableStringFieldUpdateOperationsInput | string | null
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
  ...
  export type RecentWorkCreateimagesInput = {
    set: string[]
  }

  export type RecentWorkCreatetagsInput = {
    set: string[]
  }

  export type RecentWorkCreatetoolsInput = {
    set: string[]
  }

  export type RecentWorkUpdateimagesInput = {
    set?: string[]
    push?: string | string[]
  }

  export type RecentWorkUpdatetagsInput = {
    set?: string[]
    push?: string | string[]
  }
  ...
  export type RecentWorkUpdatetoolsInput = {
    set?: string[]
    push?: string | string[]
  }
